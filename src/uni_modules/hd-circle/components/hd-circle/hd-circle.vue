 ...
 * @LastEditTime: 2023-06-04 23:30:17
 * @LastEditors: weisheng
 * @Description: Circle 环形进度条
 * @FilePath: \fant-mini-separate\uni_modules\hd-circle\components\hd-circle\hd-circle.vue
 * 记得注释
-->
<template>
	<view class="hd-circle" :style="style">
		<canvas :width="canvasHeight" :height="canvasHeight" class="hd-circle-canvas" :style="style" :id="canvasId"
